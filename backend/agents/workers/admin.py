...
class AdminAgent(BaseAgent):
    ...
    def run(self, state: dict) -> dict:
        ...
        message = "Administrative request received. Our support team will assist you."

        return {
            "messages": [AIMessage(content=message)],
            "next": None,
            "worker_results": {
                "admin_request_logged": True
            }
        }
...
def admin_agent_node(state: dict):
    return admin_agent.execute(state)